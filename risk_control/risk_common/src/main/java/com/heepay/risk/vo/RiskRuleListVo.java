...
public class RiskRuleListVo {
		...
		public String toString() {
			return "RiskRuleListVo [rulelistId=" + rulelistId + ", ruleType=" + ruleType + ", monitorObject="
					+ monitorObject + ", buziType=" + buziType + ", ruleId=" + ruleId + ", ruleDescription="
					+ ruleDescription + ", riskControlAction=" + riskControlAction + ", riskControlFact="
					+ riskControlFact + ", otherItem=" + otherItem + ", createTime=" + createTime + ", status=" + status
					+", operator=" + operator
					+ "]";
		}
