...
public class SettleProfitBathServiceTest {
	 ...
	 */
	@Test
	public void testFindListSettleProfitBath() {
		List<SettleProfitBath> findList = settleProfitBathService.findList(new SettleProfitBath());
		if(findList.size()>0){
			for (SettleProfitBath settleChannelLog : findList) {
	...
	public void testFindListExcel() {
		...
		List<Map<String, Object>> findListExcel = settleProfitBathService.findListExcel(new SettleProfitBath());
