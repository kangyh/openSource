 ...
 * 审核描述：
 */
public class HgmsInvalidContract extends DataEntity<HgmsInvalidContract> {

    private static final long serialVersionUID = 1L;
    private Long id;                    //无效合约ID
    ...
    private String status;              // 状态AUDIT_SUCCESS(
    ...
    public HgmsInvalidContract() {
        super();
    }

    public HgmsInvalidContract(String id) {
        super(id);
    }

    @Length(min = 0, max = 10, message = "合约编码公司的ID系统自动生成长度必须介于 0 和 10 之间")
