 ...
 * 审核描述：
 */
public class HgmsBatchCollectionRecordHistory extends DataEntity<HgmsBatchCollectionRecordHistory> {
    ...
    public HgmsBatchCollectionRecordHistory() {
        super();
    }

    public HgmsBatchCollectionRecordHistory(String id) {
        super(id);
    }
    ...
    public String toString() {
        return "HgmsBatchCollectionRecordHistory{" +
                "batchId='" + batchId + '\'' +
