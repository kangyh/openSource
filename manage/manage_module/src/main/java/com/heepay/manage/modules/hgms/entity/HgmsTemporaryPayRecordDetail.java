 ...
 * 审核描述：
 */
public class HgmsTemporaryPayRecordDetail extends DataEntity<HgmsTemporaryPayRecordDetail> {
    ...
    public HgmsTemporaryPayRecordDetail() {
        super();
    }

    public HgmsTemporaryPayRecordDetail(String id) {
        super(id);
    }
    ...
    @Length(min = 0, max = 32, message = "extend2长度必须介于 0 和 32 之间")
    ...
    public String toString() {
        return "HgmsTemporaryPayRecordDetail{" +
                "transId='" + transId + '\'' +
