 ...
 *
 */
public class HgmsBatchPayRecordDetail extends DataEntity<HgmsBatchPayRecordDetail> {
    ...
    public HgmsBatchPayRecordDetail() {
        super();
    }

    public HgmsBatchPayRecordDetail(String id) {
        super(id);
    }
    ...
    public String toString() {
        return "HgmsBatchPayRecordDetail{" +
                "transId='" + transId + '\'' +
