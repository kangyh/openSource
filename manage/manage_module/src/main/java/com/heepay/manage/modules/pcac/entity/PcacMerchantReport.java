...
public class PcacMerchantReport extends DataEntity<PcacMerchantReport>{
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	
	private Long  merchantReportId;
	...
	public Long getMerchantReportId() {
		return merchantReportId;
	}

	public void setMerchantReportId(Long merchantReportId) {
		this.merchantReportId = merchantReportId;
	}
