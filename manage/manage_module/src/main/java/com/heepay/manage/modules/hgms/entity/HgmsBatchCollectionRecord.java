 ...
 * 审核描述：
 */
public class HgmsBatchCollectionRecord extends DataEntity<HgmsBatchCollectionRecord> {
    ...
    public HgmsBatchCollectionRecord() {
        super();
    }

    public HgmsBatchCollectionRecord(String id) {
        super(id);
    }
    ...
    public String toString() {
        return "HgmsBatchCollectionRecord{" +
                "batchId='" + batchId + '\'' +
