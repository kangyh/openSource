 ...
 * 审核描述：
 */
public class HgmsBatchCollectionHistory extends DataEntity<HgmsBatchCollectionHistory> {
    ...
    public HgmsBatchCollectionHistory() {
        super();
    }

    public HgmsBatchCollectionHistory(String id) {
        super(id);
    }
    ...
    @Length(min = 1, max = 1, message = "是否需要审核 0需要1不需要长度必须介于 1 和 1 之间")
    ...
    public String toString() {
        return "HgmsBatchCollectionHistory{" +
                "transId='" + transId + '\'' +
