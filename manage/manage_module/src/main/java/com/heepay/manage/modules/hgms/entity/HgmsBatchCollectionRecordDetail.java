 ...
 * 审核描述：
 */
public class HgmsBatchCollectionRecordDetail extends DataEntity<HgmsBatchCollectionRecordDetail> {
    ...
    private String feeRatio;        // fee_radio
    ...
    public HgmsBatchCollectionRecordDetail() {
        super();
    }

    public HgmsBatchCollectionRecordDetail(String id) {
        super(id);
    }
    ...
    public String toString() {
        return "HgmsBatchCollectionRecordDetail{" +
                "transId='" + transId + '\'' +
