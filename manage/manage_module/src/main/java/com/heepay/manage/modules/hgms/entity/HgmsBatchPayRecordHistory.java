 ...
 *
 */
public class HgmsBatchPayRecordHistory extends DataEntity<HgmsBatchPayRecordHistory> {
    ...
    public HgmsBatchPayRecordHistory() {
        super();
    }

    public HgmsBatchPayRecordHistory(String id) {
        super(id);
    }
    ...
    public String toString() {
        return "HgmsBatchPayRecordHistory{" +
                "batchId='" + batchId + '\'' +
