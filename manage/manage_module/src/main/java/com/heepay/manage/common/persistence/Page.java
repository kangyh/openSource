 ...
 *  
 */
package com.heepay.manage.common.persistence;
...
public class Page<T> {
	 ...
	 * Page Bar .
	 */
	private final static String LABLE_PREV = "\u4e0a\u4e00\u9875"; //上一页
	private final static String LABEL_NEXT = "\u4e0b\u4e00\u9875"; //下一页
	private final static String LABEL_CURRENT= "\u5f53\u524d"; //当前
	private final static String LABEL_TOTAL = "\u5171"; //共
	private final static String LABEL_STRIP= "\u6761"; //条
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">&#171; " + LABLE_PREV + "</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&#171; " + LABLE_PREV + "</a></li>\n");
		}
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">" + LABEL_NEXT + " &#187;</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+next+","+pageSize+",'"+funcParam+"');\">"
					+ LABEL_NEXT + " &#187;</a></li>\n");
		}

		sb.append("<li class=\"disabled controls\"><a href=\"javascript:\">" + LABEL_CURRENT + " ");
		...
		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> " + LABEL_STRIP + ", ");
		sb.append(LABEL_TOTAL + " " + count + " " + LABEL_STRIP +(message!=null?message:"")+"</a></li>\n");
