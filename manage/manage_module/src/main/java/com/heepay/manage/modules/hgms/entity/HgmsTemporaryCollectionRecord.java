 ...
 * 审核描述：
 */
public class HgmsTemporaryCollectionRecord extends DataEntity<HgmsTemporaryCollectionRecord> {
    ...
    public HgmsTemporaryCollectionRecord() {
        super();
    }

    public HgmsTemporaryCollectionRecord(String id) {
        super(id);
    }
    ...
    @Length(min = 0, max = 64, message = "批量文件名称长度必须介于 0 和 64 之间")
    ...
    @Length(min = 0, max = 32, message = "extend3长度必须介于 0 和 32 之间")
    ...
    public String toString() {
        return "HgmsTemporaryCollectionRecord{" +
                "batchId='" + batchId + '\'' +
