 ...
 */
package com.heepay.manage.modules.agent.entity.agentinfochange;
 ...
 *
 */
public class AgentInfoChange extends DataEntity<AgentInfoChange> {
	...
	private String agentAreaAddr;		// 代理区域省份编码
	...
	private String agentUserId;		// 操作员编号（对应agent_user中的id字段）
	private String agentChangeStatus;		// 使用状态（枚举类AgentChangeStatus  SYSCHK系统待审 REJECT 审核拒绝 NORMAL 审核通过）
	private String agentChangeType;		// 修改类别（修改类别枚举类AgentChangeType NEWADD新增 MODIFY 修改）
	private String beginCreateTime;		// 开始 创建时间
	private String endCreateTime;		// 结束 创建时间
	
	public AgentInfoChange() {
		super();
	}

	public AgentInfoChange(String id){
		super(id);
	}

	@Length(min=1, max=10, message="代理商ID长度必须介于 1 和 10 之间")
	...
	@Length(min=0, max=6, message="代理区域省份编码长度必须介于 0 和 6 之间")
	...
	@Length(min=1, max=11, message="操作员编号（对应agent_user中的id字段）长度必须介于 1 和 11 之间")
	...
	@Length(min=1, max=6, message="使用状态（枚举类AgentChangeStatus  SYSCHK系统待审 REJECT 审核拒绝 NORMAL 审核通过）长度必须介于 1 和 6 之间")
	public String getAgentChangeStatus() {
		return agentChangeStatus;
	}

	public void setAgentChangeStatus(String agentChangeStatus) {
		this.agentChangeStatus = agentChangeStatus;
	}
	
	@Length(min=1, max=6, message="修改类别（修改类别枚举类AgentChangeType NEWADD新增 MODIFY 修改）长度必须介于 1 和 6 之间")
	public String getAgentChangeType() {
		return agentChangeType;
	}

	public void setAgentChangeType(String agentChangeType) {
		this.agentChangeType = agentChangeType;
	}
