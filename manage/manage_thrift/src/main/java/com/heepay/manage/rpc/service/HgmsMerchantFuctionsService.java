...
public class HgmsMerchantFuctionsService {
  ...
  public interface AsyncIface {
    ...
    public void save(HgmsMerchantFuctionsThrift arg0, AsyncMethodCallback resultHandler) throws TException;

    public void findList(HgmsMerchantFuctionsThrift arg0, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public HgmsMerchantFuctionsThrift recv_get() throws TException
    {
    ...
    public void send_save(HgmsMerchantFuctionsThrift arg0) throws TException
    {
    ...
    public HgmsMerchantFuctionsThrift recv_save() throws TException
    {
    ...
    public void send_findList(HgmsMerchantFuctionsThrift arg0) throws TException
    {
    ...
    public List<HgmsMerchantFuctionsThrift> recv_findList() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class get_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public HgmsMerchantFuctionsThrift getResult() throws TException {
    ...
    public static class save_call extends org.apache.thrift.async.TAsyncMethodCall {
      private HgmsMerchantFuctionsThrift arg0;
      public save_call(HgmsMerchantFuctionsThrift arg0, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.arg0 = arg0;
      }
    ...
    public static class findList_call extends org.apache.thrift.async.TAsyncMethodCall {
      private HgmsMerchantFuctionsThrift arg0;
      public findList_call(HgmsMerchantFuctionsThrift arg0, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.arg0 = arg0;
      }
      ...
      public List<HgmsMerchantFuctionsThrift> getResult() throws TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class get<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, get_args, HgmsMerchantFuctionsThrift> {
      public get() {
        super("get");
      }
      ...
      public AsyncMethodCallback<HgmsMerchantFuctionsThrift> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<HgmsMerchantFuctionsThrift>() { 
          public void onComplete(HgmsMerchantFuctionsThrift o) {
            get_result result = new get_result();
            result.success = o;
            try {
      ...
      public void start(I iface, get_args args, AsyncMethodCallback<HgmsMerchantFuctionsThrift> resultHandler) throws TException {
        iface.get(args.arg0,resultHandler);
      }
    }

    public static class save<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, save_args, HgmsMerchantFuctionsThrift> {
      public save() {
        super("save");
      }
      ...
      public void start(I iface, save_args args, AsyncMethodCallback<HgmsMerchantFuctionsThrift> resultHandler) throws TException {
        iface.save(args.arg0,resultHandler);
      }
    }

    public static class findList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, findList_args, List<HgmsMerchantFuctionsThrift>> {
      public findList() {
        super("findList");
      }
      ...
      public AsyncMethodCallback<List<HgmsMerchantFuctionsThrift>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<HgmsMerchantFuctionsThrift>>() { 
          public void onComplete(List<HgmsMerchantFuctionsThrift> o) {
            findList_result result = new findList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, findList_args args, AsyncMethodCallback<List<HgmsMerchantFuctionsThrift>> resultHandler) throws TException {
  ...
  public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable, Comparable<get_result>   {
    ...
    public HgmsMerchantFuctionsThrift success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, HgmsMerchantFuctionsThrift.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public get_result(
      HgmsMerchantFuctionsThrift success)
    {
      this();
    ...
    public get_result(get_result other) {
      if (other.isSetSuccess()) {
        this.success = new HgmsMerchantFuctionsThrift(other.success);
      }
    }
    ...
    public HgmsMerchantFuctionsThrift getSuccess() {
      return this.success;
    }

    public get_result setSuccess(HgmsMerchantFuctionsThrift success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((HgmsMerchantFuctionsThrift)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new HgmsMerchantFuctionsThrift();
  ...
  public static class save_args implements org.apache.thrift.TBase<save_args, save_args._Fields>, java.io.Serializable, Cloneable, Comparable<save_args>   {
    ...
    public HgmsMerchantFuctionsThrift arg0; // required
    ...
    public save_args(
      HgmsMerchantFuctionsThrift arg0)
    {
      this();
      this.arg0 = arg0;
    }
    ...
    public save_args(save_args other) {
      if (other.isSetArg0()) {
        this.arg0 = new HgmsMerchantFuctionsThrift(other.arg0);
      }
    }
    ...
    public HgmsMerchantFuctionsThrift getArg0() {
      return this.arg0;
    }

    public save_args setArg0(HgmsMerchantFuctionsThrift arg0) {
      this.arg0 = arg0;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ARG0:
        if (value == null) {
          ...
          setArg0((HgmsMerchantFuctionsThrift)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, save_args struct) throws TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // ARG0
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.arg0 = new HgmsMerchantFuctionsThrift();
  ...
  public static class save_result implements org.apache.thrift.TBase<save_result, save_result._Fields>, java.io.Serializable, Cloneable, Comparable<save_result>   {
    ...
    public save_result setSuccess(HgmsMerchantFuctionsThrift success) {
      this.success = success;
      return this;
    }
  ...
  public static class findList_args implements org.apache.thrift.TBase<findList_args, findList_args._Fields>, java.io.Serializable, Cloneable, Comparable<findList_args>   {
    ...
    public findList_args setArg0(HgmsMerchantFuctionsThrift arg0) {
      this.arg0 = arg0;
      return this;
    }
  ...
  public static class findList_result implements org.apache.thrift.TBase<findList_result, findList_result._Fields>, java.io.Serializable, Cloneable, Comparable<findList_result>   {
    ...
    public List<HgmsMerchantFuctionsThrift> success; // required
    ...
    public findList_result(
      List<HgmsMerchantFuctionsThrift> success)
    {
      this();
      this.success = success;
    }
    ...
    public findList_result(findList_result other) {
      if (other.isSetSuccess()) {
        List<HgmsMerchantFuctionsThrift> __this__success = new ArrayList<HgmsMerchantFuctionsThrift>(other.success.size());
        for (HgmsMerchantFuctionsThrift other_element : other.success) {
          __this__success.add(new HgmsMerchantFuctionsThrift(other_element));
        }
    ...
    public java.util.Iterator<HgmsMerchantFuctionsThrift> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(HgmsMerchantFuctionsThrift elem) {
      if (this.success == null) {
        this.success = new ArrayList<HgmsMerchantFuctionsThrift>();
      }
      this.success.add(elem);
    }

    public List<HgmsMerchantFuctionsThrift> getSuccess() {
      return this.success;
    }

    public findList_result setSuccess(List<HgmsMerchantFuctionsThrift> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<HgmsMerchantFuctionsThrift>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HgmsMerchantFuctionsThrift>(_list0.size);
                  HgmsMerchantFuctionsThrift _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new HgmsMerchantFuctionsThrift();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findList_result struct) throws TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HgmsMerchantFuctionsThrift _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HgmsMerchantFuctionsThrift _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HgmsMerchantFuctionsThrift>(_list5.size);
            HgmsMerchantFuctionsThrift _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new HgmsMerchantFuctionsThrift();
              _elem6.read(iprot);
