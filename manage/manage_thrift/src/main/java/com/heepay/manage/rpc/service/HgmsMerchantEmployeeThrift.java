...
public class HgmsMerchantEmployeeThrift implements org.apache.thrift.TBase<HgmsMerchantEmployeeThrift, HgmsMerchantEmployeeThrift._Fields>, java.io.Serializable, Cloneable, Comparable<HgmsMerchantEmployeeThrift> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("HgmsMerchantEmployeeThrift");
  ...
  static {
    schemes.put(StandardScheme.class, new HgmsMerchantEmployeeThriftStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HgmsMerchantEmployeeThriftTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(HgmsMerchantEmployeeThrift.class, metaDataMap);
  }

  public HgmsMerchantEmployeeThrift() {
  }
   ...
   */
  public HgmsMerchantEmployeeThrift(HgmsMerchantEmployeeThrift other) {
  ...
  public HgmsMerchantEmployeeThrift deepCopy() {
    return new HgmsMerchantEmployeeThrift(this);
  }
  ...
  public HgmsMerchantEmployeeThrift setEmployeeId(String employeeId) {
    this.employeeId = employeeId;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setUserId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setLevel(String level) {
    this.level = level;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setStatus(String status) {
    this.status = status;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setType(String type) {
    this.type = type;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setUpdatetime(String updatetime) {
    this.updatetime = updatetime;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setMerchantId(String merchantId) {
    this.merchantId = merchantId;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setPageNo(String pageNo) {
    this.pageNo = pageNo;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setPageSize(String pageSize) {
    this.pageSize = pageSize;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setRemarks(String remarks) {
    this.remarks = remarks;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setTotalCount(String totalCount) {
    this.totalCount = totalCount;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setEmail(String email) {
    this.email = email;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setPhone(String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public HgmsMerchantEmployeeThrift setPermission(String permission) {
    this.permission = permission;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof HgmsMerchantEmployeeThrift)
      return this.equals((HgmsMerchantEmployeeThrift)that);
    return false;
  }

  public boolean equals(HgmsMerchantEmployeeThrift that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(HgmsMerchantEmployeeThrift other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("HgmsMerchantEmployeeThrift(");
    boolean first = true;
  ...
  private static class HgmsMerchantEmployeeThriftStandardSchemeFactory implements SchemeFactory {
    public HgmsMerchantEmployeeThriftStandardScheme getScheme() {
      return new HgmsMerchantEmployeeThriftStandardScheme();
    }
  }

  private static class HgmsMerchantEmployeeThriftStandardScheme extends StandardScheme<HgmsMerchantEmployeeThrift> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HgmsMerchantEmployeeThrift struct) throws TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HgmsMerchantEmployeeThrift struct) throws TException {
      struct.validate();
  ...
  private static class HgmsMerchantEmployeeThriftTupleSchemeFactory implements SchemeFactory {
    public HgmsMerchantEmployeeThriftTupleScheme getScheme() {
      return new HgmsMerchantEmployeeThriftTupleScheme();
    }
  }

  private static class HgmsMerchantEmployeeThriftTupleScheme extends TupleScheme<HgmsMerchantEmployeeThrift> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HgmsMerchantEmployeeThrift struct) throws TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HgmsMerchantEmployeeThrift struct) throws TException {
