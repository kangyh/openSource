...
public class MerchantOperationLogService {

  public interface Iface {

    public MerchantOperationLogThrift get(String arg0) throws org.apache.thrift.TException;

    public MerchantOperationLogThrift save(MerchantOperationLogThrift arg0) throws org.apache.thrift.TException;

    public List<MerchantOperationLogThrift> findList(MerchantOperationLogThrift arg0) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void save(MerchantOperationLogThrift arg0, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;

    public void findList(MerchantOperationLogThrift arg0, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public MerchantOperationLogThrift recv_get() throws org.apache.thrift.TException
    {
    ...
    public void send_save(MerchantOperationLogThrift arg0) throws org.apache.thrift.TException
    {
    ...
    public MerchantOperationLogThrift recv_save() throws org.apache.thrift.TException
    {
    ...
    public void send_findList(MerchantOperationLogThrift arg0) throws org.apache.thrift.TException
    {
    ...
    public List<MerchantOperationLogThrift> recv_findList() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class get_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public MerchantOperationLogThrift getResult() throws org.apache.thrift.TException {
    ...
    public static class save_call extends org.apache.thrift.async.TAsyncMethodCall {
      private MerchantOperationLogThrift arg0;
      public save_call(MerchantOperationLogThrift arg0, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.arg0 = arg0;
      }
    ...
    public static class findList_call extends org.apache.thrift.async.TAsyncMethodCall {
      private MerchantOperationLogThrift arg0;
      public findList_call(MerchantOperationLogThrift arg0, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.arg0 = arg0;
      }
      ...
      public List<MerchantOperationLogThrift> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class get<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, get_args, MerchantOperationLogThrift> {
      public get() {
        super("get");
      }
      ...
      public AsyncMethodCallback<MerchantOperationLogThrift> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<MerchantOperationLogThrift>() { 
          public void onComplete(MerchantOperationLogThrift o) {
            get_result result = new get_result();
            result.success = o;
            try {
      ...
      public void start(I iface, get_args args, org.apache.thrift.async.AsyncMethodCallback<MerchantOperationLogThrift> resultHandler) throws TException {
        iface.get(args.arg0,resultHandler);
      }
    }

    public static class save<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, save_args, MerchantOperationLogThrift> {
      public save() {
        super("save");
      }
      ...
      public void start(I iface, save_args args, org.apache.thrift.async.AsyncMethodCallback<MerchantOperationLogThrift> resultHandler) throws TException {
        iface.save(args.arg0,resultHandler);
      }
    }

    public static class findList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, findList_args, List<MerchantOperationLogThrift>> {
      public findList() {
        super("findList");
      }
      ...
      public AsyncMethodCallback<List<MerchantOperationLogThrift>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<MerchantOperationLogThrift>>() { 
          public void onComplete(List<MerchantOperationLogThrift> o) {
            findList_result result = new findList_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, findList_args args, org.apache.thrift.async.AsyncMethodCallback<List<MerchantOperationLogThrift>> resultHandler) throws TException {
  ...
  public static class get_result implements org.apache.thrift.TBase<get_result, get_result._Fields>, java.io.Serializable, Cloneable, Comparable<get_result>   {
    ...
    public MerchantOperationLogThrift success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, MerchantOperationLogThrift.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public get_result(
      MerchantOperationLogThrift success)
    {
      this();
    ...
    public get_result(get_result other) {
      if (other.isSetSuccess()) {
        this.success = new MerchantOperationLogThrift(other.success);
      }
    }
    ...
    public MerchantOperationLogThrift getSuccess() {
      return this.success;
    }

    public get_result setSuccess(MerchantOperationLogThrift success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((MerchantOperationLogThrift)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new MerchantOperationLogThrift();
  ...
  public static class save_args implements org.apache.thrift.TBase<save_args, save_args._Fields>, java.io.Serializable, Cloneable, Comparable<save_args>   {
    ...
    public MerchantOperationLogThrift arg0; // required
    ...
    public save_args(
      MerchantOperationLogThrift arg0)
    {
      this();
      this.arg0 = arg0;
    }
    ...
    public save_args(save_args other) {
      if (other.isSetArg0()) {
        this.arg0 = new MerchantOperationLogThrift(other.arg0);
      }
    }
    ...
    public MerchantOperationLogThrift getArg0() {
      return this.arg0;
    }

    public save_args setArg0(MerchantOperationLogThrift arg0) {
      this.arg0 = arg0;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ARG0:
        if (value == null) {
          ...
          setArg0((MerchantOperationLogThrift)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, save_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // ARG0
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.arg0 = new MerchantOperationLogThrift();
  ...
  public static class save_result implements org.apache.thrift.TBase<save_result, save_result._Fields>, java.io.Serializable, Cloneable, Comparable<save_result>   {
    ...
    public save_result setSuccess(MerchantOperationLogThrift success) {
      this.success = success;
      return this;
    }
  ...
  public static class findList_args implements org.apache.thrift.TBase<findList_args, findList_args._Fields>, java.io.Serializable, Cloneable, Comparable<findList_args>   {
    ...
    public findList_args setArg0(MerchantOperationLogThrift arg0) {
      this.arg0 = arg0;
      return this;
    }
  ...
  public static class findList_result implements org.apache.thrift.TBase<findList_result, findList_result._Fields>, java.io.Serializable, Cloneable, Comparable<findList_result>   {
    ...
    public List<MerchantOperationLogThrift> success; // required
    ...
    public findList_result(
      List<MerchantOperationLogThrift> success)
    {
      this();
      this.success = success;
    }
    ...
    public findList_result(findList_result other) {
      if (other.isSetSuccess()) {
        List<MerchantOperationLogThrift> __this__success = new ArrayList<MerchantOperationLogThrift>(other.success.size());
        for (MerchantOperationLogThrift other_element : other.success) {
          __this__success.add(new MerchantOperationLogThrift(other_element));
        }
    ...
    public java.util.Iterator<MerchantOperationLogThrift> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(MerchantOperationLogThrift elem) {
      if (this.success == null) {
        this.success = new ArrayList<MerchantOperationLogThrift>();
      }
      this.success.add(elem);
    }

    public List<MerchantOperationLogThrift> getSuccess() {
      return this.success;
    }

    public findList_result setSuccess(List<MerchantOperationLogThrift> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<MerchantOperationLogThrift>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<MerchantOperationLogThrift>(_list0.size);
                  MerchantOperationLogThrift _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new MerchantOperationLogThrift();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, findList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (MerchantOperationLogThrift _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (MerchantOperationLogThrift _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<MerchantOperationLogThrift>(_list5.size);
            MerchantOperationLogThrift _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new MerchantOperationLogThrift();
              _elem6.read(iprot);
