...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/hgms/hgmsValidContractRcAudit/edit?id=${hgmsValidContract.id}">合约风控修改</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="hgmsValidContract" action="${ctx}/hgms/hgmsValidContractRcAudit/update" method="post" class="form-horizontal"  enctype="multipart/form-data">
    <form:hidden path="id"/>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="hgms:hgmsValidContractRcAudit:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
