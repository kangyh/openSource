...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/account/accountQuery/">账户管理列表</a></li>
		<shiro:hasPermission name="account:merchantAccount:edit"><li><a href="${ctx}/account/merchantAccount/form">账户管理添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="merchantAccount" action="${ctx}/account/accountQuery/" method="post" class="breadcrumb form-search">
		...
		<!-- 	<li class="btns"><input id="btnExport" class="btn btn-primary" type="button" onclick="onExport()" value="导出"/></li> -->
			<shiro:hasPermission name="account:merchantAccount:splManualAccount">
				<li class="btns"><input id="btnExport" class="btn btn-primary" type="button"  onclick="onSupplementManualAccount()" value="补账户"/></li>
			</shiro:hasPermission>
	...
	<shiro:hasPermission name="account:merchantAccount:splManualAccount">
		<form:form id="supplementManualAccountFrom" modelAttribute="merchantAccount" action="${ctx}/account/accountQuery/gotoSupplementAccount" method="post" class="breadcrumb form-search">
		</form:form>
	</shiro:hasPermission>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="merchantAccount">
			<tr>
				...
				<td>
					<a href="${ctx}/account/accountQuery/form?id=${merchantAccount.accountId}">
