...
<head>
	...
	<script type="text/javascript">
		...
		//搜索
		function onSubmit(){
			$("#searchForm").attr("action","${ctx}/payment/accountSettleQuery/");
			validateFrom.validate($("#searchForm"));
		}
		function onExport(){
			$("#searchForm").attr("action","${ctx}/payment/accountSettleQuery/accountSettleExport/");
			validateFrom.validate($("#searchForm"));
		}
...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/payment/accountSettleQuery/">账务结算报表管理</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="merchantLog" action="${ctx}/payment/accountSettleQuery/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<shiro:hasPermission name="payment:accountSettleExport:view">
