...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/hgms/hgmsMerchantInfoLegal/audit?id=${hgmsMerchantInfo.merchantId}&goal=3">资金归集商户法务审核页面</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="hgmsMerchantInfo" action="${ctx}/hgms/hgmsMerchantInfoLegal/update" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="control-right">
            ...
            <div class="controls">
                <form:select path="creditLevel" class="input-xlarge required">
                    ...
                    <form:options items="${creditLevel}" itemLabel="name" itemValue="value" htmlEscape="false" class="input-xlarge required"/>
                </form:select>
            </div>
        </div>
    </div>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="hgms:hgmsMerchantInfoLegal:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="通 过" onclick="return pass();"/>&nbsp;</shiro:hasPermission>
        <shiro:hasPermission name="hgms:hgmsMerchantInfoLegal:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="拒 绝" onclick="return reject();"/>&nbsp;</shiro:hasPermission>
