...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/payment/merchantLog/">交易账务列表</a></li>
		<li class="active"><a href="javascript:void(0)">交易账务详情查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchantLog" action="${ctx}/payment/merchantLog/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
