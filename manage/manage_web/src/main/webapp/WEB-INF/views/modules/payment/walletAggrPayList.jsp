...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			//控制输入框只能输入数字
			$("#transNo,#merchantOrderNo").keyup(function(){
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/payment/wallet/aAggrPayList">个人钱包支付列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="paymentRecord" action="${ctx}/payment/wallet/aAggrPayList" method="post" class="breadcrumb form-search">
