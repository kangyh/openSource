...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/riskManage/RiskMerchantFreezeQueryJd">解冻审核列表</a></li>
	</ul>
	<form action="${ctx}/riskManage/RiskMerchantFreezeQueryJd" method="post" id="formBtn"></form>
	<form:form id="searchForm" modelAttribute="riskMerchantFreeze" action="${ctx}/riskManage/RiskMerchantFreezeQueryJd" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="riskMerchantFreeze">
			...
			<c:if test="${riskMerchantFreeze.status == '解冻待审核'}">
				<tr>
				...
				<td>
					<c:if test="${riskMerchantFreeze.status == '解冻待审核'}">
						<a href="${ctx}/riskManage/RiskMerchantFreezeQueryJd/tojd/${riskMerchantFreeze.freezeId}/${page.pageNo}">解冻审核</a>
					</c:if>
