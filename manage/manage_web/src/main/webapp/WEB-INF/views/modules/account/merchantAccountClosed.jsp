...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:void(0)">关闭账户</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchantAccount" action="${ctx}/account/accountQuery/closed" method="post" class="form-horizontal">
