...
<form:form id="inputForm" modelAttribute="riskMerchantFreeze" action="${ctx}/riskManage/RiskMerchantFreezeQuery/dj/${riskMerchantFreeze.freezeId}" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input value="${riskMerchantFreeze.createAuthor}" readOnly="true"style="border:0px;background-color:#fff;padding-top: 3px;width:300px;"/>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">操作状态：</label>
		<div class="controls">
			<input  value="${riskMerchantFreeze.status}" readOnly="true" style="border:0px;background-color:#fff;padding-top: 3px;width:300px;"/>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
			...
			<div class="controls">
				  <form:input path="freezeMessage" htmlEscape="false" class="required" maxlength="20" placeholder="请输入备注信息,不超过20个数" style="width:300px;"/>
