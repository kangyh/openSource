...
function check() {
	...
	if(opStatusNote==null || opStatusNote==""){
		...
		loading('正在提交，请稍等...');
		$.ajax({
			url:"${ctx}/pcac/pcacPersonReport/view/syndicBatch/",
			type:"post",
			cache:false,
			timeout:10000,
			data:{
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/pcac/pcacPersonReport/view">个人商户信息列表</a></li>
		<li class="active"><a>批量审核</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="syndicEntity" action="${ctx}/pcac/pcacPersonReport/view/syndicBatch/" method="post" class="form-horizontal">
		
		
		<div style="font-size: 2em;font-family: serif;font: bold;padding-bottom: 20px;padding-top: 20px;">个人商户信息批量审核:</div>
	...
	<form  id="searchForm" modelAttribute="pcacPersonReport" action="${ctx}/pcac/pcacPersonReport/view/handle" method="post"  >
