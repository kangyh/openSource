...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			//控制输入框只能输入数字
			$("#transNo,#walletMerchantId,#merchantId").keyup(function(){
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/payment/wallet/withdrawDepositList">个人钱包提现列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="paymentRecord" action="${ctx}/payment/wallet/withdrawDepositList" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="pay">
			<tr>
				...
				<td <c:if test="${pay.status=='SUCCES'}">
					...
					${fns:getDictLabel(pay.status, 'WithdrawStatus', '')}
				</td>
			</tr>
		</c:forEach>
		</tbody>
