...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>企业商户信息上报</a></li> 
	</ul>
	<form:form id="searchForm" modelAttribute="pcacMerchantReport" action="${ctx}/pcac/pcacMerchantReport/view/readyUploadFile/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="ppReportInfo" varStatus="index">
			<tr>
				...
				<td>
					<a href="${ctx}/pcac/pcacMerchantReport/view/viewDetail?merchantReportId=${ppReportInfo.merchantReportId}&type=view&fromWhere=upload&param=hidden">详情</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
	...
	<div class="pagination">${page}</div>
		...
		<form id="loadForm" action="${ctx}/pcac/pcacMerchantReport/view/loadModel" method="post" enctype="multipart/form-data" class="form-horizontal">
			<div class="control-group" style="margin-top:30px">
				<div class="control-left">
				<label class="control-label">企业信息明细：</label>
					<div class="controls">
						<input type="file" name="file" id="uploadId"/>
						<span class="info"><a href="${ctxStatic}/pcac/pcacMerchantReport.xls">点击下载模板</a></span>
