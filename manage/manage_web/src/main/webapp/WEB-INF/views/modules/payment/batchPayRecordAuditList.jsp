...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/payment/batchPayRecordAudit/">转账审核列表</a></li>
		...
		<c:forEach items="${page.list}" var="batchPayRecord">
			<tr>
				...
				<td>
					...
					<a href="${ctx}/payment/batchPayRecordAuditDetail/toAudit?batchId=${batchPayRecord.batchId}">
						审核
					</a>
				</td>
				<%--</shiro:hasPermission>--%>
