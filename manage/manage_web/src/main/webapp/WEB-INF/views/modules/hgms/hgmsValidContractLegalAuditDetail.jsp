...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/hgms/hgmsValidContractLegalAudit/form?id=${hgmsValidContract.id}">合约法务详情</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hgmsValidContract" action="${ctx}/hgms/hgmsValidContractAudit/" method="post" class="form-horizontal">
		<form:hidden path="id"/>
