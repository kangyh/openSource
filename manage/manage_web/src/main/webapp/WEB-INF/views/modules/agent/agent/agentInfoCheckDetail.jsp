...
<head>
	...
	<script type="text/javascript">
        ...
        function doCheck(status){
            window.location="${ctx}/agent/agent/agentInfo/doCheck?agentStatus="+status+"&id="+$('#id').val();
		}
	</script>
</head>
<body>
	...
	<%--</ul><br/>--%>
	<form:form id="inputForm" modelAttribute="agentInfo" class="form-horizontal">
		<form:hidden path="id"/>
...
<%--					<form:input path="headName" htmlEscape="false" maxlength="50" class="input-xlarge required"/>
		...
		<div class="control-group">
			...
			<div class="control-right">
				...
				<div class="controls">
					<input value="${agentInfo.legalIdcardExpiry}" maxlength="18" readonly style="border:0px;background-color:#fff;padding-top: 3px;" />
