...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/merchant/onlineContractInfoLegal?cache=1">产品签约列表</a></li>
		<li class="active"><a href="">产品签约审核</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="onlineContractInfo" action="${ctx}/merchant/onlineContractInfoLegal/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
