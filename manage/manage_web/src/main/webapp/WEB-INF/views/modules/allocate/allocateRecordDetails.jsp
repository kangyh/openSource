...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/allocate/allocateRecord/details?allocateId=${allocateRecord.allocateId}">调拨详情</a></li>
	</ul>
	...
	<div class="form-actions">
	   <input type="button" class="btn" value="返回" onclick="javascript:window.location='${ctx}/allocate/allocateRecord/list';"/>					
	</div>
</body>
</html>