...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/subject/subject/form?id=${subject.id}">科目<shiro:hasPermission name="subject:subject:edit">${not empty subject.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="subject:subject:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="subject" action="${ctx}/subject/subject/save" method="post" class="form-horizontal">
		...
		<div class="control-group" id="parentSubjectDiv" style="display: none;">
			<label class="control-label">上级科目：</label>
			<div class="controls">
				<form:select id="parentSubjectId" path="parentSubjectId" class="input-xlarge required">
					<form:option value="" label=""/>
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
