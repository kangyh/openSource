...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hgms/hgmsInvalidContract/?merchantId=${invalidContract}">无效合约列表</a></li>
		<li class="active"><a href="${ctx}/hgms/hgmsInvalidContract/form?id=${hgmsInvalidContract.contractId}">无效合约<shiro:hasPermission name="hgms:hgmsInvalidContract:edit">查看</shiro:hasPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hgmsInvalidContract" action="${ctx}/hgms/hgmsInvalidContract/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<c:if test="${not empty hgmsInvalidContract.contractFileAddress}">
					<a class="media" href="${hgmsInvalidContract.contractFileAddress}" target="_blank">合同文件</a>
				</c:if>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<div class="control-left">
				...
				<div class="controls">
					<input name="enteringTime" type="text" readonly class="input-xlarge" value="<fmt:formatDate value="${hgmsInvalidContract.validityBeginTime}" pattern="yyyy-MM-dd"/>" style="border:0px;background-color:#fff;padding-top: 3px;"/>
				</div>
			</div>
			<div class="control-right">
				<label class="control-label">有效期结束：</label>
				<div class="controls">
					<input name="enteringTime" type="text" readonly class="input-xlarge" value="<fmt:formatDate value="${hgmsInvalidContract.validityEndTime}" pattern="yyyy-MM-dd"/>" style="border:0px;background-color:#fff;padding-top: 3px;"/>
				</div>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="control-right">
				...
				<div class="controls">
					<input name="legalAuditTime" type="text" readonly value="<fmt:formatDate value="${hgmsInvalidContract.legalAuditTime}" pattern="yyyy-MM-dd"/>" style="border:0px;background-color:#fff;padding-top: 3px;"/>
				</div>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="control-right">
				...
				<div class="controls">
					<input name="rcAuditTime" type="text" readonly value="<fmt:formatDate value="${hgmsInvalidContract.rcAuditTime}" pattern="yyyy-MM-dd"/>" style="border:0px;background-color:#fff;padding-top: 3px;"/>
				</div>
			</div>
		</div>
		<div class="control-group">
			<div class="control-left">
				...
				<div class="controls">
					<input name="enteringTime" type="text" class="input-xlarge" readonly value="<fmt:formatDate value="${hgmsInvalidContract.enteringTime}" pattern="yyyy-MM-dd"/>" style="border:0px;background-color:#fff;padding-top: 3px;"/>
				</div>
			</div>
			<div class="control-right">
		...
		<div class="form-actions">
			<shiro:hasPermission name="hgms:hgmsInvalidContract:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
