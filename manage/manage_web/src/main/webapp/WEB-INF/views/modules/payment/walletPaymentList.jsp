...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/payment/wallet/paymentList">个人钱包支付列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="innerTransferRecord" action="${ctx}/payment/wallet/paymentList" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>转出商户号：</label>
				<form:input path="fromMerchantId" htmlEscape="false" maxlength="18" class="input-medium" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}
			...
			<li><label>转入商户号：</label>
				<form:input path="toMerchantId" htmlEscape="false" maxlength="18" class="input-medium" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}
					else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
			</li>
			<li><label>主商户号：</label>
				<form:input path="merchantId" htmlEscape="false" maxlength="18" class="input-medium" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}
					else{this.value=this.value.replace(/\D/g,'')}" onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"/>
			</li>
			<li><label>支付状态：</label>
