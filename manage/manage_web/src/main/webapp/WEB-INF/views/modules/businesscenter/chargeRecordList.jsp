...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/business/businessChargeRecord/getChargeRecordList">充值管理列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="chargeRecord" action="${ctx}/business/businessChargeRecord/getChargeRecordList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped   table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="chargeRecord">
			<tr >
				...
				<td>
					<a href="${ctx}/business/businessChargeRecord/form?id=${chargeRecord.id}">${chargeRecord.id}</a>
			    </td>
				<td>
	...
	<script type="text/javascript">
		$(function(){
			...
			$.ajax({
				type : "POST",
				url : "${ctx}/business/businessChargeRecord/getStatisticsList",
				data : {
					"chargeId" : chargeId,
