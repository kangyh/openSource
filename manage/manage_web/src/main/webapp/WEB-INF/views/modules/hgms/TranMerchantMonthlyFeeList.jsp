...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/hgms/hgmsMerchantFeeManagementObj/">商户月结手续费查询</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="hgmsMerchantFeeManagementObj" action="${ctx}/hgms/hgmsMerchantFeeManagementObj/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>月份：</label>
				...
				<input name="createTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					   value="<fmt:formatDate value="${hgmsMerchantFeeManagementObj.createTime}" pattern="yyyy-MM"/>"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="hgmsMerchantFeeManagementObj" varStatus="status">
			<tr>
				...
				<td>
					<fmt:formatDate value="${hgmsMerchantFeeManagementObj.createTime}" pattern="yyyy-MM"/>
				</td>
				...
				<shiro:hasPermission name="hgms:hgmsMerchantFeeManagementObj:view"><td>
					<form:form id="searchForm${ status.index + 1}" modelAttribute="hgmsMerchantFeeManagementObj" action="${ctx}/hgms/hgmsMerchantFeeManagementObj/detaillist" method="post" >
