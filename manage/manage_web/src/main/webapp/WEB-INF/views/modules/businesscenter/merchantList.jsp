...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/business/merchant/getMerchantList">商户列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="merchant" action="${ctx}/business/merchant/getMerchantList" method="post" class="breadcrumb form-search">
