...
<body>
	...
	<form:form id="inputForm" modelAttribute="allocateMonitor" action="${ctx}/allocate/allocateMonitor/updateAllocateMonitor" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="allocate:allocateMonitor:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="修 改"/>&nbsp;</shiro:hasPermission>
