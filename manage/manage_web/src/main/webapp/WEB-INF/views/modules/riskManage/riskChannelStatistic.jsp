...
<body>
	<div class="control-group">
		<div class="controls">
			<div style="text-align:center;padding-top: 20px;font-size: 2em;font-family: serif;font: bold;padding-bottom: 20px;">风控通道订单成功率趋势图</div>
		</div>
		<li hidden><a id="url_id" href="${ctx}/risk/riskChannelRatioReporter/"></a></li>
	</div>
	<div class="control-group">
		<div class="controls" align="left" style="padding-top: 20px;width:20%;">
			<div style="width:1500px;">
                ...
                <label>通道合作方：</label>
                <select id="channelPartnerCode" class="input-xlarge" onchange="checkValue(this)" style="position:relative;bottom:4px;">
                    <option value="">请选择</option>
                    <c:forEach items="${dataEntity}" var="wStatus">
