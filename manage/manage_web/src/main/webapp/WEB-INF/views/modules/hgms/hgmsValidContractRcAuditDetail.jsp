...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hgms/hgmsValidContractRcAudit/">合约列表</a></li>
		<li class="active"><a href="${ctx}/hgms/hgmsValidContractRcAudit/detail?id=${hgmsValidContract.id}">合约查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hgmsValidContract" action="${ctx}/hgms/hgmsValidContractRcAudit/" method="post" class="form-horizontal">
		<form:hidden path="id"/>
