...
<body>
	...
	<form:form id="inputForm" modelAttribute="riskOrderFreeze" action="${ctx}/riskManage/riskOrderFreezeQuery/jd/${riskOrderFreeze.freezeId}" method="post" class="form-horizontal">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input path="merchantName" name="merchantName" id="merchantName" value="${riskOrderFreeze.merchantName}" readOnly="true" style="border:0px;background-color:#fff;padding-top: 3px;"/>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input path="transNo" name="transNo" id="transNo" value="${riskOrderFreeze.transNo}" readOnly="true" style="border:0px;background-color:#fff;padding-top: 3px;"/>
		</div>
	</div>
