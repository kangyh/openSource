...
<head>
	...
	<script type="text/javascript">
        ...
        function pass(){
            ...
            if('${hgmsValidContract.rcAuditStatus}'=='待审核') {
                $("#rcAuditStatus").val('SUCCES');
                $("#status").val('SUCCES');
                $('#contractStatus').val("NORMAL");
            }
        }
        function reject(){
            if($("#objection").val() == ""){
...
<ul class="nav nav-tabs">
	<li><a href="${ctx}/hgms/hgmsValidContractRcAudit/">合约风控列表</a></li>
	<li class="active"><a href="${ctx}/hgms/hgmsValidContractRcAudit/form?id=${hgmsValidContract.id}">合约风控审核</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="hgmsValidContract" action="${ctx}/hgms/hgmsValidContractRcAudit/audit" method="post" class="form-horizontal">
	<form:hidden path="id"/>
	...
	<div class="control-group">
		<div class="control-left">
			...
			<div class="controls">
				<input name="enteringTime" type="text" class="input-xlarge" readonly value="<fmt:formatDate value="${hgmsValidContract.enteringTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" style="border:0px;background-color:#fff;padding-top: 3px;"/>
			</div>
		</div>
		<div class="control-right">
	...
	<div class="form-actions">
		<shiro:hasPermission name="hgms:hgmsValidContractRcAudit:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="通 过" onclick="return pass();"/>&nbsp;</shiro:hasPermission>
		<shiro:hasPermission name="hgms:hgmsValidContractRcAudit:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="拒 绝" onclick="return reject();"/>&nbsp;</shiro:hasPermission>
