...
<head>
    ...
    function getProduct(businessType){
        ...
        $.ajax({
               async: false, 
               type: "GET",
               url: "${ctx}/merchant/product/getProduct",
...
<body>
	...
	<form:form id="inputForm" modelAttribute="merchantRateNew" action="${ctx}/merchant/merchantDefaultRateNew/save" method="post" class="form-horizontal">
		...
		<input type="hidden" id="productCode1" value="${merchantRateNew.productCode}"/>
		<form:hidden path="merchantId"  value="1"/>
		<form:hidden path="merchantCompanyName" value="汇元网" />
		<div class="control-group">
			<label class="control-label">业务类型：</label>
			<div class="controls">
				<form:select path="businessType" class="input-xlarge" id="businessType">
...
<%-- 		<div class="control-group" id="ruleBeginTimeDiv">
		...
		<div class="form-actions">
			<shiro:hasPermission name="merchant:merchantDefaultRateNew:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" onclick="return confirmation()" value="保 存" onclick="return pass();"/>&nbsp;</shiro:hasPermission>
