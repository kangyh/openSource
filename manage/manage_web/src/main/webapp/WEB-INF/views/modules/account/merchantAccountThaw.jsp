...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:void(0)">账户解冻</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchantAccount" action="${ctx}/account/accountQuery/thaw" method="post" class="form-horizontal">
