        ...
        $(document).ready(function() {
            ...
            $(function(){
                ...
                $("input[name='loginName']").blur(function(){
                    var loginNameCheck = $(this).val().trim();
                    //邮箱验证
                    ...
                    $.ajax({
                        type: "GET",
                        url: "${ctx}/hgms/hgmsMerchantInfo/regist",
                        data: {'loginName':loginNameCheck},
                        success: function(data){
                            if(1==data){
                                $(".errorMsg").html("<b style='color:green'>商户名可用</b>");
                            }else if(0==data) {
                                $(".errorMsg").html("<b style='color:red'>商户名不可用</b>");
                                //模拟聚焦事件发生
                                $("input[name='loginName']").focus();
                            }else{
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/hgms/hgmsMerchantInfo/form?id=${hgmsMerchantInfo.id}">资金归集商户<shiro:hasPermission name="hgms:hgmsMerchantInfo:edit">${not empty hgmsMerchantInfo.merchantId?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="hgms:hgmsMerchantInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="hgmsMerchantInfo" action="${ctx}/hgms/hgmsMerchantInfo/save" method="post" class="form-horizontal" enctype="multipart/form-data">
		<form:hidden path="id"/>
        ...
        <div class="control-group">
            <div class="control-left">
                ...
                <div class="controls">
                    <form:input id="loginName" path="loginName" htmlEscape="false" maxlength="50" class="input-xlarge required" name="loginName" placeholder="邮箱格式" />
                    <span class="errorMsg"><font color="red">*</font></span>
                </div>
            </div>
        ...
        <div class="control-group">
            <div class="control-left">
                ...
                <div class="controls">
                    ...
                    <span class="help-inline"><font color="gray">*</font></span>
                </div>
            </div>
            <div class="control-right">
        ...
        <div class="control-group">
            <div class="control-left">
                ...
                <div class="controls">
                    <form:input id="bankcardNo" path="bankcardNo" htmlEscape="false" maxlength="19" class="input-xlarge required" onchange="CheckBankNo(this)" placeholder="14 - 19 的数字"/>
                    <span class="help-inline"><font color="red">*</font></span>
                </div>
            </div>
            <div class="control-right">
        ...
        <div class="control-group">
            <div class="control-left">
                ...
                <div class="controls">
                    <form:input id="associateLineNumber" path="associateLineNumber" class="input-xlarge required"  readonly="true" style="border:0px;background-color:#fff;padding-top: 3px;"/>
                    <span class="help-inline"><font color="red">*</font> </span>
                </div>
            </div>
        ...
        <div class="control-group">
            ...
            <%--PermitsAccountsFile         onchange="loadLegalCertificateFrontFileImage(this)"     --%>
        </div>
        <div class="control-group">
