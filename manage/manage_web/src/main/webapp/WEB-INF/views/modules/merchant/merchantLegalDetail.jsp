...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/merchant/merchantLegal/">法务审核列表</a></li>
		<li class="active"><a href="">法务审核详情</a></li>
	</ul>
	<br />
	<form:form id="inputForm" modelAttribute="merchant"  class="form-horizontal">
		...
		<div class="control-group">
			<div class="control-left">
				...
				<div class="controls">
					...
					<p class="pop_img">
						<span>X</span>
						<label>${merchant.legalCertificateFront}</label>
		...
		<div class="control-group">
			<div class="control-left">
				...
				<%-- <input value="${merchant.cityCode}" maxlength="100" readonly style="border:0px;background-color:#fff;padding-top: 3px;" />
				<input value="${merchant.countyCode}" maxlength="100" readonly style="border:0px;background-color:#fff;padding-top: 3px;" /> --%>
				</div>
			</div>
			<div class="control-right">
		...
		<div class="control-group">
            <div class="control-left">
                ...
                <div class="controls">
                <input value="${merchant.legalAuditor}" maxlength="100" readonly style="border:0px;background-color:#fff;padding-top: 3px;" />
                </div>
            </div>
            <div class="control-right">
                <label class="control-label">审核时间：</label>
                <div class="controls">
                    <fmt:formatDate value="${merchant.legalAuditTime}" pattern="yyyy-MM-dd"/>
                </div>
            </div>
        </div>
		<div class="control-group">
			...
			<div class="controls">
			<input value="${merchant.legalAuditStatus}" readonly style="border:0px;background-color:#fff;padding-top: 3px;" />
			</div>
		</div>
		<c:if test="${merchant.legalAuditStatus=='审核不通过'}">
			<div class="control-group">
