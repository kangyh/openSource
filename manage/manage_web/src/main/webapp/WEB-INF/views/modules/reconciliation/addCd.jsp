			...
			$("#inputForm").validate({
				submitHandler: function(form){
					...
					if(requestAmount != successAmount){
						$("#successAmountId").text("金额不一致，不能进行撤单");
						return false;
					}
					loading('正在提交，请稍等...');
					form.submit();
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">处理撤单页面</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="settleDifferRecord" action="${ctx}/reconciliation/SettleDifferRrecord/differences/cd/${settleDifferRecord.differId}" method="post" class="form-horizontal">
