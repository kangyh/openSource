...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:void(0)">账户启用</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchantAccount" action="${ctx}/account/accountQuery/enable" method="post" class="form-horizontal">
