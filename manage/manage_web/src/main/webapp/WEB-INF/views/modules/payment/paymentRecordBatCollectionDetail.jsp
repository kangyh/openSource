...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:void(0)">代收详情查看</a></li>
	</ul><br/>
	${batchCollectionRecordDetail}
	<form:form id="inputForm" modelAttribute="batchCollectionRecordDetail" action="${ctx}/payment/paymentRecord/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				${batchCollectionRecordDetail.batchId}
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
					${batchCollectionRecordDetail.merchantCompany}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">商户账号：</label>
			<div class="controls">
					${batchCollectionRecordDetail.accountId}
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">转账总金额(元)：</label>
			<div class="controls">
					${batchCollectionRecordDetail.collectAmount}
			</div>
		</div>
		<div class="control-group">
