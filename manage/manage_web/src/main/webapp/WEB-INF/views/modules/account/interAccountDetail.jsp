...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/account/interAccountQuery/">内部账户管理列表</a></li>
		<li class="active"><a href="javascript:void(0)">内部账户详情查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchantAccount" action="${ctx}/account/interAccount/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
