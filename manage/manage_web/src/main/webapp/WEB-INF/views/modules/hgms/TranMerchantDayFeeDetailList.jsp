...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/hgms/hgmsMerchantFeeManagementObj/dayFeeList">商户日结手续费明细查询</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:if test="${feeManageobjPay !=null }">
			<tr>
				...
				<td>
					<fmt:formatDate value="${feeManageobjPay.createTime}" pattern="yyyy-MM-dd"/>
				</td>
				<td>
		...
		<c:if test="${feeManageobjCollection !=null }">
			<tr>
				...
				<td>
					<fmt:formatDate value="${feeManageobjCollection.createTime}" pattern="yyyy-MM-dd"/>
				</td>
				<td>
