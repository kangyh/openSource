...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#">人工处理页面</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="settleDifferRecord" action="${ctx}/reconciliation/SettleDifferRrecord/differences/xxcl/${settleDifferRecord.differId}" method="post" class="form-horizontal">
