...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/cbms/merchant/merchantRc/audit?id=${merchant.userId}">风控审核修改</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="merchant" action="${ctx}/cbms/merchant/merchantRc/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="merchant:merchantRc:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保存"/>&nbsp;</shiro:hasPermission>
