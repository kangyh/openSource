	...
	<form:form id="inputForm" modelAttribute="merchant" action="${ctx}/merchant/merchantLegal/status" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="control-right">
				...
				<div class="controls">
					<input name="certificateType" value="${merchant.certificateType}" htmlEscape="false" style="border:0px;background-color:#fff;padding-top: 3px;" readonly="true" value="多证合一营业执照"/>
				</div>
			</div>
		</div>
