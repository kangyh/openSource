...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/pcac/pcacMerchantReport/view/">企业商户信息上报列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="pcacMerchantReport" action="${ctx}/pcac/pcacMerchantReport/view/" method="post" class="breadcrumb form-search">
		...
		<tbody>
			<c:forEach items="${page.list}" var="ppReportInfo" varStatus="seq">
				<tr>
					...
					<td>
							<c:if test="${pcacMerchantReport.opStatus eq '01' or pcacMerchantReport.opStatus eq '02'   or pcacMerchantReport.opStatus eq '03'}">
								<a href="${ctx}/pcac/pcacMerchantReport/view/viewDetail?merchantReportId=${ppReportInfo.merchantReportId}&type=view&param=hidden">详情</a>
							</c:if>
							<c:if test="${pcacMerchantReport.opStatus eq '04' or pcacMerchantReport.opStatus eq '05'    or pcacMerchantReport.opStatus eq '06' }">
							<a href="${ctx}/pcac/pcacMerchantReport/view/viewBatchDetail?batchNo=${ppReportInfo.batchNo}&opStatus=${pcacMerchantReport.opStatus}&type=view&pageNo=1">批次详情</a>
							</c:if>
					</td>			
				</tr>
			</c:forEach>
