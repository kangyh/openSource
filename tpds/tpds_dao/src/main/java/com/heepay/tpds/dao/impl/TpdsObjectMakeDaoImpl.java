 ...
 */
@Repository
public class TpdsObjectMakeDaoImpl extends BaseDaoImpl<TpdsObjectMake,TpdsObjectMakeExample> implements TpdsObjectMakeMapper{
	
	// 默认构造方法设置命名空间
	public TpdsObjectMakeDaoImpl() {
		super.setNs("com.heepay.tpds.dao.TpdsObjectMakeMapper");
	}
