...
public class FastDFSUtils {
     ...
     */
    //上传图片 返回图片路径
    public static String uploadPic(byte[] pic, String name, Long size,String path) throws Exception {
        
       
        //设置成功
        try {
            //ClientGlobal.init("/hy/deploy/tpds_server/tpds_server-1.0-SNAPSHOT/conf/fdfs_client.conf");
