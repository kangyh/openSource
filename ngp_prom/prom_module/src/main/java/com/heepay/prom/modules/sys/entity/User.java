 ...
 *  
 */
package com.heepay.prom.modules.sys.entity;
...
import com.heepay.common.util.Collections3;
...
public class User extends DataEntity<User> {
	...
	private String macInfo;//网卡
	
	private String cpuInfo;//cpu
	
	private String diskInfo;//硬盘
	...
	/**     
	* @discription 判断是否是admin
	* @author ly     
	* @created 2016年12月16日 下午5:03:20     
	* @param userType
	* @return     
	*/
