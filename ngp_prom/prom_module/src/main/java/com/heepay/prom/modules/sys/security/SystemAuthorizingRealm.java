...
import com.heepay.prom.common.utils.DynamicPasswordUtil;
...
import com.heepay.prom.common.servlet.ValidateCodeServlet;
import com.heepay.prom.common.utils.SpringContextHolder;
import com.heepay.prom.common.web.Servlets;
...
import com.heepay.prom.modules.sys.utils.LogUtils;
import com.heepay.prom.modules.sys.utils.UserUtils;
import com.heepay.prom.modules.sys.web.LoginStatic;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
  ...
  private static final Logger logger = LogManager.getLogger();
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		// 校验登录验证码
		if (LoginStatic.isValidateCodeLogin(token.getUsername(), false, false)){
		...
		if (user != null) {
			...
			// 校验口令
			if(Constants.IS_CHECK_YES.equals(DictUtils.getSysCommonDictValue(Constants.IS_CHECK))){
				if(!Constants.DYNAMIC_STATUS.equals(DynamicPasswordUtil.check(token.getManageCode(),user))){
					throw new AuthenticationException("msg:口令错误");
				}
			}
