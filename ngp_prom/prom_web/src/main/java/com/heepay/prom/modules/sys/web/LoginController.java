...
import com.heepay.prom.common.utils.IdGen;
import com.heepay.prom.common.utils.RandomUtil;
import com.heepay.prom.common.web.BaseController;
import com.heepay.prom.modules.sys.security.FormAuthenticationFilter;
...
public class LoginController extends BaseController {
    ...
    public String getNum(HttpServletResponse response, HttpServletRequest request)  {
        String sKey = GetRandom.generateString(32);
        String key = CookieUtils.getCookie(request, "prom.session.id");
