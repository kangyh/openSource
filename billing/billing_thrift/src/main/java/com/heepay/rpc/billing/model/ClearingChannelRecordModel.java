...
public class ClearingChannelRecordModel implements org.apache.thrift.TBase<ClearingChannelRecordModel, ClearingChannelRecordModel._Fields>, java.io.Serializable, Cloneable, Comparable<ClearingChannelRecordModel> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ClearingChannelRecordModel");
  ...
  static {
    schemes.put(StandardScheme.class, new ClearingChannelRecordModelStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ClearingChannelRecordModelTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ClearingChannelRecordModel.class, metaDataMap);
  }

  public ClearingChannelRecordModel() {
  }
   ...
   */
  public ClearingChannelRecordModel(ClearingChannelRecordModel other) {
  ...
  public ClearingChannelRecordModel deepCopy() {
    return new ClearingChannelRecordModel(this);
  }
  ...
  public ClearingChannelRecordModel setTransNo(String transNo) {
    this.transNo = transNo;
    return this;
  }
  ...
  public ClearingChannelRecordModel setSettleStatus(String settleStatus) {
    this.settleStatus = settleStatus;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ClearingChannelRecordModel)
      return this.equals((ClearingChannelRecordModel)that);
    return false;
  }

  public boolean equals(ClearingChannelRecordModel that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ClearingChannelRecordModel other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ClearingChannelRecordModel(");
    boolean first = true;
  ...
  private static class ClearingChannelRecordModelStandardSchemeFactory implements SchemeFactory {
    public ClearingChannelRecordModelStandardScheme getScheme() {
      return new ClearingChannelRecordModelStandardScheme();
    }
  }

  private static class ClearingChannelRecordModelStandardScheme extends StandardScheme<ClearingChannelRecordModel> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ClearingChannelRecordModel struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClearingChannelRecordModel struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ClearingChannelRecordModelTupleSchemeFactory implements SchemeFactory {
    public ClearingChannelRecordModelTupleScheme getScheme() {
      return new ClearingChannelRecordModelTupleScheme();
    }
  }

  private static class ClearingChannelRecordModelTupleScheme extends TupleScheme<ClearingChannelRecordModel> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ClearingChannelRecordModel struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ClearingChannelRecordModel struct) throws org.apache.thrift.TException {
